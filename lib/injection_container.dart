...
import 'core/audio_engine/just_audio_engine.dart';
...
Future<void> init() async {
  ...
  //! Core
  // Audio Engine — real implementation using just_audio.
  // Each call to loadPreview creates per-track AudioPlayer instances.
  sl.registerFactory<IAudioEngineService>(() => JustAudioEngine());
